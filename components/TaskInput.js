    ...
    return (
      <Modal visible={props.showModal} animationType="slide">
        <View style={styles.inputContainer}>
          ...
          {show&&mode=='date' ? <DateTimePicker value={new Date()} mode={mode} accentColor={'#b180f0'} onChange={onChangeDate}/> : null}
          {show&&mode=='time' ? <DateTimePicker value={new Date()} mode={mode} accentColor={'#b180f0'} onChange={onChangeTime}/> : null}
